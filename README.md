...
- [AI Code Completion & Autocomplete (17)](#ai-code-completion--autocomplete)
- [AI Code Generation (9)](#ai-code-generation)
- [AI Development Environments (4)](#ai-development-environments)
- [AI Security & Code Review (12)](#ai-security--code-review)
...
- [Supermaven](https://supermaven.com) - Fastest AI code completion tool with a 1 million token context window, enabling superior suggestions across large codebases. Supports VS Code, JetBrains, and Neovim, adapting to user coding style for 2x faster development. Integrates chat for debugging and refactoring using top models like GPT-4o and Claude 3.5 Sonnet. ([Read more](/details/supermaven.md)) `Autocomplete` `Large Context` `Multi Ide`
...
- [Zed](https://zed.dev) - High-performance code editor built in Rust with native AI integration for agentic editing, parallel agents, and LLM collaboration. Supports multibuffers, Vim/Helix modes, and extensions for seamless human-AI workflows. Optimized for speed across macOS, Linux, Windows. ([Read more](/details/zed.md)) `High Performance` `Agentic Editing` `Rust`
...
- [CodeRabbit](https://coderabbit.ai) - AI-powered code review tool that cuts review time and bugs in half, integrating with GitHub, GitLab, and IDEs. Analyzes PRs with codebase context, generates fixes, tests, and docstrings while learning from team feedback. Trusted by 15,000+ teams including NVIDIA for agentic reviews. ([Read more](/details/coderabbit.md)) `Code Review` `Pr Analysis` `Agentic`
