...
- [Windsurf](https://windsurf.com) - An agentic AI-powered IDE by Codeium, featuring deep codebase understanding, multi-step AI flows, and collaborative coding assistance. ([Read more](/details/windsurf-com.md)) `AI IDE` `agentic AI` `code generation` `codebase awareness`
