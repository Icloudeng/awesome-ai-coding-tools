...
- [Cursor](https://cursor.com) - An AI-first code editor built on VS Code, featuring intelligent code generation, multi-file editing, and natural language commands for coding tasks. ([Read more](/details/cursor-com.md)) `AI code editor` `code generation` `multi-file editing`
